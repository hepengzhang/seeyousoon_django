...
class peopleActivitiesTest(TestCase):
    ...
    def test_createMyActivity(self):
        contents = {"activity_id": 10, "access": 0, "type": "1", "description": "description", "longitude": 931.291,
                    "keyword": "keyword", "start_date": "2012-08-22T16:20:09", "num_of_participants": 10}
        expected_contents = {"activity_id": 1, "access": 0, "type": "1", "description": "description",
                             "longitude": 931.291, "keyword": "keyword", "start_date": "2012-08-22T16:20:09",
